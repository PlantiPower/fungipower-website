...
const Footer: React.FC<FooterProps> = ({ dict, lang }) => {
  ...
  return (
    <footer className="relative pt-32 pb-12 bg-gradient-to-b from-[#011410] to-[#000d0a] overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-orange-500/5 blur-[120px] rounded-full pointer-events-none"></div>
        ...
        <div className="grid md:grid-cols-3 gap-12 lg:gap-20 mb-16">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="text-[10px] font-black uppercase tracking-[0.4rem] text-orange-400">FungiPower</div>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item.key}>
                    <Link href={getPath(item.key, lang)} className="text-orange-50 hover:text-orange-400 transition-colors flex items-center gap-2 group">
                      <span className="w-1.5 h-1.5 rounded-full bg-orange-500 shadow-[0_0_8px_rgba(132,204,22,0.6)]"></span>
                      {item.name}
                    </Link>
                  </li>
                ))}
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4 text-orange-50 group">
                ...
                <div className="text-orange-100/60 text-sm leading-relaxed">
                  {t.address.line1}<br />
                  {t.address.line2}<br />
                  {t.address.country}
                </div>
